...
// Log API key presence for debugging (never do this in production!)
...
export async function POST(request: Request) {
  try {
    ...
    console.log('Using Hugging Face API key:', process.env.HUGGINGFACE_API_KEY ? 'API key is set' : 'API key is NOT set');
